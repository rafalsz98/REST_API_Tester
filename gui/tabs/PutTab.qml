    ...
    Put
        {
            ...
            onReplyReady: function() {
                AppManager.body = put.getBody();
                AppManager.headers = put.getHeaders();
                AppManager.statusCode = put.getStatusCode();
        ...
        Connections {
            ...
            function onClicked(_) {
                put.setUrl(ipField.text);
                put.parseParameters(parameters.getList());
                put.run();
            }
        }
